    ...
    <footer className="relative bg-gradient-to-br from-gray-900 to-gray-800 text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16 sm:py-20 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-12">
          ...
          {/* Rest of the sections (Quick Links, Contact Info, Newsletter) go here unchanged... */}
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to={"/find-players"}>
                  <span
                    href="#"
                    className="text-gray-300 cursor-pointer hover:text-white hover:pl-2 transition-all duration-300 flex items-center"
                  >
                    <span className="w-1 h-1 bg-blue-500 rounded-full mr-2 opacity-0 group-hover:opacity-100 transition duration-300"></span>
                    Players
                  </span>
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; <span id="year" className="text-blue-400"></span> TecSolix.
            All rights reserved.
          </p>
