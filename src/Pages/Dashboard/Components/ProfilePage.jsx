      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 relative z-10">
        ...
        >
          ...
          <div className="p-6 sm:p-8 flex flex-col sm:flex-row items-center sm:items-end -mt-20 sm:-mt-16 space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <motion.button
              onClick={() => handleEdit(loggedInUser._id)}
              whileHover={{
                scale: 1.05,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            <motion.div
              ...
              className="bg-white/70 backdrop-blur-lg rounded-2xl shadow-lg p-6 border border-gray-200"
            >
            ...
            >
              ...
              <div className="space-y-3">
                <motion.button className="w-full flex items-center px-4 py-3 border border-gray-300 rounded-lg text-gray-700 bg-white/50 hover:bg-gray-100 transition">
                  <LockIcon className="h-5 w-5 mr-3 text-gray-500" />
                  Change Password
                </motion.button>
                <motion.button
                  onClick={handleLogout}
                  className="w-full flex items-center px-4 py-3 border border-transparent rounded-lg text-white bg-gradient-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 transition"
                >
